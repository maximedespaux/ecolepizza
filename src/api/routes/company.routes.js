...
const { getCompanies, getCompany, createCompany, updateCompany, registerCompanyStagiaires, detachLearner, companyDocTemplates, listCompanyDocuments, createCompanyDocument } = require('../controllers/company.controller.js');
