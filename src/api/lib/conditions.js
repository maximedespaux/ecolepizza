...
const DEFAULT_ENABLED = new Set([
    ...
    // Migration 173 : type d'activité, équipement, avancement, formation.
    'learner.project_dine_in',
    'learner.project_takeaway',
    'learner.project_by_slice',
    'learner.project_vending',
    'learner.project_catering',
    'learner.project_add_on',
    'learner.project_kneader',
    'learner.project_sheeter',
    'learner.project_fridge_counter',
    'learner.project_oven_owned',
    'learner.project_premises',
    'learner.project_funded',
    'learner.project_opening_soon',
    'learner.project_support',
    'learner.project_more_training',
...
const FR_LABELS = {
    ...
    // Migration 173.
    project_dine_in: 'Projet : pizzeria sur place',
    project_takeaway: 'Projet : à emporter / livraison',
    project_by_slice: 'Projet : pizza à la part',
    project_vending: 'Projet : distributeur automatique',
    project_catering: 'Projet : traiteur / événementiel',
    project_add_on: 'Projet : pizza en complément d\'un commerce',
    project_kneader: 'Projet : pétrin',
    project_sheeter: 'Projet : laminoir / façonneuse',
    project_fridge_counter: 'Projet : saladette / vitrine réfrigérée',
    project_oven_owned: 'Projet : four déjà acheté',
    project_premises: 'Projet : local trouvé',
    project_funded: 'Projet : financement obtenu',
    project_opening_soon: 'Projet : ouverture sous 6 mois',
